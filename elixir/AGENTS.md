...
This directory contains the Elixir agent orchestration service that polls GitHub Issues, creates per-issue workspaces, and runs Codex in app-server mode.
